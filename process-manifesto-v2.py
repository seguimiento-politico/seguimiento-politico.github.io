                ...
                if m['id'] == p['ref_id']:
                    if 'ref_parent_chapter' in p:
                        ...
                        if p['ref_parent_chapter'] == chapter_string:
                            ...
                            if 'ref_section' in p:
                                proposal['ref_section'] = p['ref_section']
                            else:
                                proposal['ref_section'] = ""
                            # set promise content
                            proposal['children'] = []
                            part = {}
                            if 'description' in p:
                            ...
                            for statement in p['statements']: 
                                ...
                                if partial == False:
                                    ...
                                    proposal['children'].append({'promise': part})
                                    part = {}

                            #monitor possible error
                            if partial == True:
                                print(colored("Error de formato: ", 'red'), proposal)
...
def go_deeper(dict):
    ...
    for item in dict:
        ...
        global chapter_promises_cont 
        chapter_promises_cont = 0
        proposals = get_promises(chapters)
        for item in proposals:
            if not 'children' in part:
                part['children'] = []
            part['children'].append({'proposal': item})
